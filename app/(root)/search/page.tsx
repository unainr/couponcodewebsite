    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center py-6 bg-white rounded-lg shadow-sm p-6 max-w-2xl mx-auto mt-8">
          ...
          <p className="text-gray-600">Enter a search term above to discover coupons and stores.</p>
        </div>
      </div>
    );
  }
  ...
  try {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-gray-600 mb-6">Found {totalResults} results for "<span className="font-medium">{searchTerm}</span>"</p>
        ...
        {totalResults === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-8 text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-4">We couldn't find any matches for "{searchTerm}"</p>
            <p className="text-gray-500 text-sm">Try using different keywords or check for typos</p>
          </div>
        ) : (
          <>
            {/* Stores Section */}
            {stores.length > 0 && (
              <div className="mb-10">
                <h2 className="text-2xl font-semibold mb-4 flex items-center">
                  ...
                  Stores <span className="text-gray-500 font-normal ml-2">({stores.length})</span>
                </h2>
            ...
            {coupons.length > 0 && (
              <div>
                <h2 className="text-2xl font-semibold mb-4 flex items-center">
                  ...
                  Coupons <span className="text-gray-500 font-normal ml-2">({coupons.length})</span>
                </h2>
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-2xl mx-auto">
          ...
          <p className="text-red-600">An error occurred while fetching search results. Please try again later.</p>
          <button 
